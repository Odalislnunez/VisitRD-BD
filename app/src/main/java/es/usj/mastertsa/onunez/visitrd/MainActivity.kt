...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val firstPlace = Place("Bahía de las Aguilas", "Parque Nacional de Jaragua, Prov. Pedernales",
            "Es una bahía del mar Caribe, localizada en la parte central de la costa meridional de la isla de Santo Domingo, y considerada como la playa más cristalina del mundo. Administrativamente, es parte de la provincia de Pedernales de la República Dominicana.",
